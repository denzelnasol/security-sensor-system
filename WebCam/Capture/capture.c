...
/**
 * The following code is a modification of Derek Molloy's Beaglbone CV code,
 * with additional modifications from Team Solar's guide on webcam streaming
 * from a BeaglBone to a NodeJS server
 */
